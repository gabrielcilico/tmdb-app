...
class UpcomingStore = UpcomingStoreBase with _$UpcomingStore;

abstract class UpcomingStoreBase extends AbstractTypedStore with Store {
  final MoviesService _moviesService;

  UpcomingStoreBase(this._moviesService);
  ...
  Future<void> fetchMovies() async {
    setIsLoading(true);
    var response = await _moviesService.upcomingMovies(nextPage);
